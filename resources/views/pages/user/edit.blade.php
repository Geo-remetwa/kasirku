                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <img src="{{ Storage::disk('public')->exists($item->photo) ? Storage::disk('public')->url($item->photo) : url('assets/img/image_not_available.png') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="roles">
                                            ...
                                            <option value="user" {{ ($item->roles !== 'admin') ? 'selected' : '' }}>User</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
